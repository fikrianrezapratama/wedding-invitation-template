...
export const defaultSettings: Omit<SerializedSettings, "galleryItems"> = {
  id: 1,
  brideName: "Alya",
  groomName: "Fikri",
  eventTitle: "Acara Lamaran",
  eventDate: new Date("2026-06-21T10:00:00.000Z").toISOString(),
  ...
  mapEmbedUrl: "https://www.google.com/maps?q=Grand+Kemang+Ballroom&output=embed",
